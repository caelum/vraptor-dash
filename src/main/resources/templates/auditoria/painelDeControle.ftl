...
<link rel="StyleSheet" href="<c:url value="/css/painelDeControle.css"/>" type="text/css" />
<link rel="StyleSheet" href="<c:url value="/css/tablesorter.css"/>" type="text/css" />
...
<script type="text/javascript" src="<c:url value="/js/jquery-table-me.js"/>"></script>
